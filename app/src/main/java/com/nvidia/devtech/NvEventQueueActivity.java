...
import com.turan.game.ui.tab.Tab;
import com.turan.game.ui.Hud;
import com.turan.game.ui.Speedometer;
...
public abstract class NvEventQueueActivity extends AppCompatActivity implements SensorEventListener, View.OnTouchListener {
 ...
 //   protected SensorManager mSensorManager = null;
    ...
    public void updateHudInfo(int health, int armour, int weaponid, int ammo, int ammoinclip,
        ...
        runOnUiThread(() -> {
            mHud.UpdateHudInfo(health, armour, weaponid, ammo, ammoinclip,
    ...
    public void showHudLogo() {
        runOnUiThread(() -> {
            if (mHud != null) {
                mHud.setLogoVisibility(true);
            }
        });
    }

    public void hideHudLogo() {
        runOnUiThread(() -> {
            if (mHud != null) {
                mHud.setLogoVisibility(false);
            }
        });
    }
