...
public class LoadGameActivity extends AppCompatActivity {
    ...
    private static final String CACHE_ZIP_PATH = Environment.getExternalStorageDirectory() + "/Android/data/com.turan.game/cache.zip";
    private static final String EXTRACT_DIR = Environment.getExternalStorageDirectory() + "/Android/data/com.turan.game/";
    private static final String VERSION_DIR = Environment.getExternalStorageDirectory() + "/Android/data/com.turan.game/files/";
    ...
    private void updateProgress(int progress, long downloadedBytes, long totalBytes) {
        runOnUiThread(() -> {
            ...
            if (progress < 70) {
                ...
                // Остановить видео при завершении установки
