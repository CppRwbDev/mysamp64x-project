...
import com.turan.game.SAMP;
import com.turan.game.ui.LoadingScreen;
import com.turan.launcher.api.API;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private boolean isCacheInstalled() {
        try {
            File[] possiblePaths = {
                    new File(Environment.getExternalStorageDirectory() + "/Android/data/com.turan.game/files/version.txt"),
