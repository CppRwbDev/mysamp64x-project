...
void WorldVehicleAdd(RPCParameters* rpcParams)
{
    ...
    // Custom models support: allow IDs 400+
    if(VehicleInfo.iVehicleType < 400) {
        return;
    }
...
void RPC_Fuel(RPCParameters* rpcParams)
{
    float fuel;
...
void RegisterRPCs(RakClientInterface *pRakClient)
{
	...
	static int iRPC_Fuel = 210;
	pRakClient->RegisterAsRemoteProcedureCall(&iRPC_Fuel, RPC_Fuel);
}
