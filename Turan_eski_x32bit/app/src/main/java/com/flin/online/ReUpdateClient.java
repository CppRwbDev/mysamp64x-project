...
public class ReUpdateClient extends AppCompatActivity {
    ...
    private ReUpdateClient.DownloadProcess downloadThread;
       ...
       /* GregorianCalendar gcalendar = new GregorianCalendar();
        ...
        if (Build.VERSION.SDK_INT != Build.VERSION_CODES.KITKAT){
            ...
            if (permissionStatus == PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(ReUpdateClient.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
            }
        }
        else {
            SelectTypeAPP = 1;
    ...
    public void AlternationInstall(int count) {
        if(PublicInfo.currentFilesUpdate == 1) {
            switch (count) {
                ...
                case 2: {
                    //AlternationInstall(AlternationCount +=1);
                    Intent intent = new Intent(ReUpdateClient.this, InstallAPKActivity.class);
            ...
            if (PublicInfo.checkSelectInstall == 0) {
                switch (count) {
                    ...
                    case 3: {
                        ...
                        new ReUpdateClient.UnZipFiles(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + PublicInfo.checkFilesClient1, Environment.getExternalStorageDirectory()  + "/FlinOnline/").execute();
                    ...
                    case 5: {
                        ...
                        new ReUpdateClient.UnZipFiles(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + name_archive, Environment.getExternalStorageDirectory()  + "/FlinOnline/").execute();
                        break;
                    }
                    case 6: {
                    ...
                    case 10: {
                        ...
                        Intent intent = new Intent(ReUpdateClient.this, MenuActivity.class);
                        startActivity(intent);
    ...
    {
        private ReUpdateClient.ExtractProgressDialogView pd;
        ...
        protected void onPreExecute() {
            ...
            lastTaskDone = false;
            PowerManager pm = (PowerManager) ReUpdateClient.this.
            ...
            pd = new ExtractProgressDialogView(ReUpdateClient.this, R.layout.progress_dialog);
        ...
        {
            ReUpdateClient.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    // TODO Auto-generated method stub
            ...
            if(params!=null && params.length==2)
            {
                ...
                if( ( ret = v.extractArchive(params[0], params[1],exback = new ExtractCallback() {
                    ...
                    public long setRatioInfo(long inSize, long outSize) {
                        ...
                        ReUpdateClient.ArchiveExtractCallback.this.inSize = inSize;
                        ReUpdateClient.ArchiveExtractCallback.this.outSize = outSize;
                        publishProgress("-R","");
                        return 0;
                    }
    ...
    public void DownloadFiles(String URL, String FileName, String nameStatus, String nameDescription,  String namesetTitle) {
        ...
        downloadThread = new ReUpdateClient.DownloadProcess();
