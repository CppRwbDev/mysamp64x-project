...
import com.flin.core.DialogClientSettingsFPSFragment;
import com.flin.core.DialogClientSettingsHUDFragment;
import com.flinc.core.DialogClientSettingsAdapter;
import com.flin.core.DialogClientSettingsColorFragment;
...
public class DialogClientSettings extends DialogFragment {
                             ...
                             Bundle savedInstanceState)
    {
       ...
       // adapter.addFragment("Оружие", DialogClientSettingsWeaponsFragment.createInstance("weapons").setRoot((ViewGroup)rootview.findViewById(R.id.ll_settings_root)));
        ...
        ((AppCompatImageView)rootview.findViewById(R.id.dialog_settings_button_close)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((AppCompatImageView)rootview.findViewById(R.id.dialog_settings_button_reset)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
